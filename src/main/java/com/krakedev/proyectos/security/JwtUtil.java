...
public class JwtUtil {
	...
	private static final String CLAVE_SECRETA = "Quelosecosdelaperdiciónresuenenporestemundomiserable,paraquetodoslosquevivenpuedanoírlosydesesperarse.";

	private static final String EMISOR = "DarkMajin_BK";
